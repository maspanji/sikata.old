...
<body>
	<div class="container">
		...
		<div class="mt-4"> <!-- judul -->
			...
			<h5 class="text-center" style="font-weight: bold; line-height: 20px;">NO : PKL.<?php echo $registrasi['id_registrasi'] ?> / SK / DEK / FT.AK / IV / 2019</h5>
			<h5 class="text-center m-4" style="font-weight: bold; line-height: 20px;">TENTANG</h5>
			<h5 class="text-center m-4" style="font-weight: bold; line-height: 20px;">PEMBIMBING PRAKTEK KERJA LAPANGAN (PKL)
				<br/> 
		...
		<div class="isi">
			...
			<ol type="1" style="text-align: justify; font-size: 20px; margin-left: 15px">
				<li>Nama Mahasiswa/i&emsp;&emsp;&emsp;&emsp; : <?php echo $registrasi['nama_mhs'] ?></li>
				<p style="text-align: justify; font-size: 20px">Nomor Induk Mahasiswa/i&emsp;: <?php echo $registrasi['nim_mhs'] ?> (<?php echo $registrasi['nama_prodi'] ?>)<br/>
					Telah memenuhi syarat untuk mengambil Praktek Kerja Lapangan dengan judul : <br/> <?php echo $registrasi['judul_pkl'] ?>
				</p>
				<li>Dosen pembimbing untuk Praktek Kerja Lapangan (PKL) mahasiswa/i tersebut diatas ditetapkan : <br/> <?php echo $registrasi['nama_dosbim'] ?></li>
				<li>Dosen Pembimbing Praktek Kerja Lapangan (PKL) diberikan honorarium sebagaimana peraturan yang berlaku.</li>
