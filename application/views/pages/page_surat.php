...
$this->fpdf->Ln(); $this->fpdf->Cell(19,0.5,'subtitle',0,0,'C'); 
...
$this->fpdf->Ln(1); 
$this->fpdf->SetFont('Times','B',12); 
$this->fpdf->Cell(6 , 1, 'Nama' , 1, 'LR', 'L'); 
$this->fpdf->Cell(5 , 1, 'NIM' , 1, 'LR', 'L'); 
/* generate hasil query disini */ 
foreach($registrasi as $data) 
	{ 
		$this->fpdf->Ln(); 
		$this->fpdf->SetFont('Times','',12); 
		$this->fpdf->Cell(6 , 0.7, $data->nama_mhs , 1, 'LR', 'L'); 
		$this->fpdf->Cell(5 , 0.7, $data->nim_mhs , 1, 'LR', 'L'); 
	} 
	...
	$this->fpdf->Output("Surat_Keputusan.pdf","I"); 
