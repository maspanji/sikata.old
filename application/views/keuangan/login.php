...
<head>
	...
	<!-- <link rel="stylesheet" type="text/css" href="https://demos.creative-tim.com/material-kit/assets/demo/demo.css"> -->
</head>
<body>
					...
					<div class="card">
						...
						<form class="form-signin" action="<?php echo base_url('keuangan/action_login'); ?>" method="post">
							<div class="card-header card-header-rose text-center">
								...
								<h4 class="card-title mt-0" style="font-weight: bold;">Login Keuangan</h4>
							</div>
							<div class="card-body py-3">
								...
								<button type="submit" class="btn btn-rose btn-block my-3">Login</button>
							</div>
						</form>
					</div>
				</div>
