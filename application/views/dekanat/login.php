		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-6 ml-auto mr-auto">
					<div class="card">
						<form class="form-signin" action="<?php echo base_url('dekanat/action_login'); ?>" method="post">
							<div class="card-header card-header-warning text-center">
								<img src="<?php echo base_url() ?>assets/img/logo-unkris.png" class="mb-0" style="width: 100px">
								<h4 class="card-title mt-0" style="font-weight: bold;">Login Dekanat</h4>
							</div>
							<div class="card-body py-3">
								...
								<button type="submit" class="btn btn-warning btn-block my-3">Login</button>
							</div>
						</form>
					</div>
				</div>
